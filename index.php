...
$OtomobilSorgusu = $VeritabaniBaglantisi->prepare("SELECT  * FROM ilanlar");
$OtomobilSorgusu->execute();
            ...
            <div class="row">
                <div class="col col-md-3">
                    <div class="row">
                        ...
                        <div class="col-sm col-md-8 mb-0"><a class="text-dark" href="index.php"><h4>Otomobil</h4></a>
                        </div>
                    </div>
                    <hr>
                    <!--Araçlar logo son-->
                    <div class="row">
                        <ul style="list-style-type: none;">
                            <?php
                            $OtomobilSorgusu = $VeritabaniBaglantisi->prepare("SELECT DISTINCT IlanMarka FROM ilanlar");
                            $OtomobilSorgusu->execute();
                            ...
                            foreach ($Otomobiller as $Marka) {
                                ...
                                <li><a class="text-dark"
                                       href="ilanlistesi.php?Marka=<?php echo $Marka["IlanMarka"] ?>"><?php echo $Marka["IlanMarka"] ?> </a>
                                </li>
                                <?php
                            }
                            ?>
                ...
                <div class="col col-md-9">
                    <div class="row">
                        <?php
                        $OtomobilSorgusu = $VeritabaniBaglantisi->prepare("SELECT  * FROM ilanlar  ORDER BY IlanId DESC LIMIT $GosterimBaslangici,$YazdirilacakSayi");
                        $OtomobilSorgusu->execute();
                        $OtomobilSayisi = $OtomobilSorgusu->rowCount();
                        $Otomobiller = $OtomobilSorgusu->fetchAll(PDO::FETCH_ASSOC);
                        foreach ($Otomobiller as $Marka) {
                            ...
                            <div class="col-sm col-md-2 mr-2 mt-2">
                                <div class="row">
                                    <a href="ilanicerik.php?IlanID=<?php echo $Marka["IlanId"]; ?>" class="">
                                        <img src="resimler/urunler/araclar/<?php echo $Marka["IlanResimBir"]; ?>"
                                             class="mb-1 " width="95%" height="95%">
                                    </a>
                                </div>
                                <div class="row">
                                    <a href="ilanicerik.php?IlanID=<?php echo $Marka["IlanId"]; ?>"
                                       style=" text-overflow: clip; width: 99%;height: 50px;">
                                        <small class="text_yaz text-justify text-dark mt-2 mb-2"
                                               style=" text-overflow: clip;"><?php echo $Marka["IlanBasligi"]; ?></small>
                                    </a>
                                </div>
                            </div>
                            <?php
                    ...
                    <center>
                        ...
                        for ($id = 1; $SayfaSayisi >= $id; $id++) {
                            ?>
                            <a href="index.php?sayfa=<?php echo $id ?>">
                                <button type="button" class="btn btn-info"><?php echo $id ?></button>
                            </a>
                            <?php
                        }
                        ?>
