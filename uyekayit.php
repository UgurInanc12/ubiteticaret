    ...
    <div class="container bg-dark mt-3 mb-4 pb-4">
        ...
        <div class="container bg-light p-4 mb-2 mt-3">
            ...
            <div class="col-md-6 offset-md-3">
                <form class="align-center" method="post" action="uyekayitsonuc.php">
                    <div class="card wow fadeInRight" data-wow-delay="0.3s">
                        <div class="card-body ">
                            <!--Header-->
                            <div class="text-center">
                                <h3 class="white-text">
                                    <i class="fas fa-user white-text"></i> Üye Kayıt :</h3>
                                <hr class="hr-light">
                                <p>Aşağıdan üye girişi yapabilirsiniz.</p>
                            </div>
                            <!--Body-->
                            <!--
                            <div class="md-form">
                            ...
                            <div class="md-form">
                                ...
                                <input type="password" id="form2" name="Sifre" class="white-text form-control">
                                <label for="form2" class="active"> Şifre (*)</label>
                            </div>
                            <div class="md-form">
                                <i class="fas fa-user white-text"></i>
                                <input type="text" id="form1" name="Isim" class="white-text form-control">
                                <label for="form4">İsim (*)</label>
                            </div>


                            <div class="md-form">
                                <i class="fas fa-phone-square-alt"></i>
                                <input type="text" id="form3" name="TelNumarasi" class="white-text form-control">
                                <label for="form4">Telfon Numarası (*)</label>
                            </div>
