    ...
    <div class="container bg-dark mt-3 mb-4 pb-4">
        ...
        <div class="container bg-light p-4 mb-2 mt-3">
            ...
            <div class="col-md-6 offset-md-3">
                <form class="align-center" method="post" action="uyeguncellesonuc.php?ID=<?php echo $Uye["ID"]; ?>">
                    <div class="card wow fadeInRight" data-wow-delay="0.3s">
                        <div class="card-body ">
                            <!--Header-->
                            <div class="text-center">
                                <h3 class="white-text">
                                    <i class="fas fa-user white-text"></i> Üye Guncelle :</h3>
                                <hr class="hr-light">
                                <p>Aşağıdan uye bilgilerini güncelleyebilirsiniz .</p>
                            </div>
                            <!--Body-->
                            <!--
                            <div class="md-form">
                            ...
                            <div class="md-form">
                                ...
                                <input type="text" id="form3" name="TelNumarasi" value="<?php echo $Uye["Phone"]; ?>"
